...
class Canvas(QWidget):
    ...
    def timeout(self):
        ...
        #todo 11
        self.feedback = points_to_qpolygonF(np.array(qpolygonF_to_points(self.path)) * (100-self.counter)/nb_step + np.array(qpolygonF_to_points(self.termination)) * self.counter/nb_step)
